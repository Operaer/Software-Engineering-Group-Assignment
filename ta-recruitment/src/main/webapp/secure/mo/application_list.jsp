        ...
        <div class="card-body">
            ...
            <table id="appListTable" class="table table-hover">
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <button class="btn btn-sm btn-outline-info" onclick="viewProfile('ta1@example.com')">View Profile</button>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <button class="btn btn-sm btn-outline-info" onclick="viewProfile('ta2@example.com')">View Profile</button>
                        <button class="btn btn-sm btn-outline-secondary">View Resume</button>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-end">
                        <button class="btn btn-sm btn-outline-info" onclick="viewProfile('ta3@example.com')">View Profile</button>
                        <button class="btn btn-sm btn-outline-secondary">View Resume</button>
                    </td>
                </tr>
                </tbody>
...
<script>
    ...
    function viewProfile(email) {
        window.open('<%= request.getContextPath() %>/secure/mo/view-profile?email=' + encodeURIComponent(email), '_blank');
    }
</script>
