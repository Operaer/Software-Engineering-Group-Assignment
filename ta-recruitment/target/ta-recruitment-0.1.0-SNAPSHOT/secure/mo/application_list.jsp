...
<script>
    ...
    function applyAppFilters() {
        ...
        rows.forEach(row => {
            if (row.cells.length < 5) return; // Skip the "no applications" row
            ...
            const matchKeyword = keyword === '' || ta.includes(keyword) || position.includes(keyword) || skills.includes(keyword);
